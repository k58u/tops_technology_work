    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stud_city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Studentapp1.city')),
                ('stud_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Studentapp1.course')),
            ],
        ),
    ]
